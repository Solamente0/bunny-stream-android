...
class LibraryViewModel : ViewModel() {
    ...
    fun loadLibrary() {
        ...
        scope.launch {
            try {
                val response = App.di.streamApi.videosApi.videoList(
                    libraryId = libraryId,
                    page = null,
                    itemsPerPage = null,
                    search = null,
    ...
    fun onDeleteVideo(video: Video) {
        ...
        scope.launch {
            try {
                val result = App.di.streamApi.videosApi.videoDeleteVideo(libraryId, video.id)
    ...
    private fun VideoModel.toVideo(): Video {
        Log.d(TAG, "thumbnailFileName=$thumbnailFileName status?.value=${status?.value}")
        return Video(
