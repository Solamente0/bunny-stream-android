...
import net.bunnystream.recording.domain.StreamHandler

class BunnyRecordingView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : FrameLayout(context, attrs, defStyleAttr), RecordingView {
