...
| [onPlayerError](on-player-error.md) | [androidJvm]<br>abstract fun [onPlayerError](on-player-error.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) |
